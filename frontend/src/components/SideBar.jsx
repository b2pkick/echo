...
const SideBar = () => {
  ...
  return (
    <div className = {`${open?"translate-x-0":"-translate-x-full"} overflow-y-auto h-full w-full md:w-100 flex flex-col absolute transition-all duration-500 left-0 bg-black opacity-70 text-white items-center text-4xl z-1000 p-10`}>
        ...
        <div className='w-full flex-1 h-full overflow-y-auto flex flex-col items-center p-4'>
          {isUsersLoading ? (
            ...
            <button key={user._id} onClick={()=>{setSelectedUser(user)}} className={`flex justify-center items-center gap-2`}>
